...
* File Name: main.c
*
* Description: This is the source code for PSoC 4 MCU CAPSENSE MSC Guard
*              sensor community code example for ModusToolbox.
*
...
#define USER_LED_PORT                    (7u)
#define USER_LED_NUM				     (3u)
#define LED_ON						     (0u)
#define LED_OFF						     (1u)
...
bool guard_sensor_status = false;
...
*    4. scan touch input continuously
*
* Return:
*  int
*
...
static void led_control(void)
{
    if((MSC_CAPSENSE_WIDGET_INACTIVE != Cy_CapSense_IsWidgetActive
       ...
       !Cy_CapSense_IsWidgetActive(CY_CAPSENSE_GUARDSENSOR_WDGT_ID,
       &cy_capsense_context))
    {
